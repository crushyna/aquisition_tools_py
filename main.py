...
import data.templateColumns
from data.functions import createExcelFile
from data.functions import createTextFromExcelFile
import time
import os
import openpyxl
import xlrd
...
templates = {1:'CUSTOMER_POLICY_LINK', 2:'CUSTOMERS', 3:'INTERMEDIARIES', 4:'INTERMEDIARY_POLICY_LINK', 5:'INTERMEDIARY_TYPE', 6:'OPERATIONS', 7:'PARTY_ROLE', 8:'POLICIES', 9:'POLICY_STATUS', 10:'PRODUCT_SOURCE_TYPE', 11:'COUNTRY', 12:'PRODUCT', 13:'TRANSACTIONS'}
    ...
    if ans=="1":
      ...
      if selectedFileId < txtFilesNumber:
          ...
          if int(selectedTemplateKey) <= len(templates):
              ...
              print("Inproper selection, try again!")
              time.sleep(2)
      else:
          print("Inproper file name. Try again!")
          time.sleep(2) 
      ...
      time.sleep(1)
      createExcelFile(currentFile, fileTemplate)
      ...
      if selectedFileId < excelFilesNumber:
          ...
          createTextFromExcelFile(currentExcelFile)
      else:
